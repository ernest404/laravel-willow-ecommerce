        ...
        <nav class="navbar float-right theme-main-menu one-page-menu">
           ...
           <div class="collapse navbar-collapse" id="navbar-collapse-1" style="width: 100%;">
            ...
            <li>
                ...
                <li class="dropdown-holder" style="z-index: 100;"><a href="#blog-section">Categories</a>
                    <ul class="sub-menu">
                            @forelse ($categories as $category)
                           <li><a href="/Shop/{{$category->name}}" class="tran3s">{{$category->name}}</a></li>
                           @empty
                           <li><a href="" class="tran3s">Categories not available</a></li>
                           @endforelse
                       </ul>
                </li>
            ...
            <li class="dropdown-holder" >
                    <a  href="#">
                            <i class="fa fa-user" aria-hidden="true"></i><span style="fo">{{ Auth::user()->name }}</span> <span class="caret"></span>
                    </a>
