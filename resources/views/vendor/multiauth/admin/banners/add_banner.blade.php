      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            <form enctype="multipart/form-data" class="form-horizontal" method="PUT" action="BannerController@store" name="add_banner" id="add_banner" novalidate="novalidate">{{ csrf_field() }}
